...
export const metadata: Metadata = {
  ...
  description:
    "Все направления работ: шлифовка, покраска, тёплый шов, обсада и окосячка, отделочные работы.",
      ...
      <section className="bg-bark-950 py-16 text-white lg:py-24">
        <div className="container-page">
          ...
          <p className="mt-5 max-w-2xl text-lg text-bark-200">
            Широкий спектр работ: от подготовки древесины и покраски до тёплого шва, обсады
            и комплексной отделки.
          </p>
        </div>
      </section>
